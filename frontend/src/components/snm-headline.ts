...
export class SnmHeadline extends LitElement {
  ...
  render() {
    ...
    const styleClassesTable = {
      h1: "text-2xl mb-5 p-3 inline-block font-bold bg-ab_bg_gray border-l-4 border-solid border-ab_navy",
      h2: "text-xl mb-2 py-1 px-2 font-bold bg-transparent border-l-4 border-solid border-ab_navy",
