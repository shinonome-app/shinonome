  ...
  def associate_receipt(worker:, person:, current_admin_user:, receipt_form:)
    Work.transaction do
      ...
      receipt.update!(
        work_id: work.id,
        worker_id: worker.id,
        last_name_kana: receipt_form.last_name_kana,
        last_name: receipt_form.last_name,
        last_name_en: receipt_form.last_name_en,
        first_name_kana: receipt_form.first_name_kana,
        first_name: receipt_form.first_name,
        first_name_en: receipt_form.first_name_en,
        person_note: receipt_form.person_note,
        email: receipt_form.email,
        person_id: person.id,
        started_on: receipt_form.started_on,
        title: receipt_form.title,
        title_kana: receipt_form.title_kana,
